...
dfE = 15 - (5 + 1)
dfT = 15 - 1
adjrsq = 1 - ssesst*dfE/dfT
```


The adjusted Rsquare is given by 1 - (SSE/dfE)/(SST/dfT). We also know that $R^2 = 1 - SSE/SST$. So SSE/SST = 1 - $R^2$ = `r 1 - 0.995`. We also have dfE = `15 - (5 + 1)` and dfT = `15 - 1`. Plugging everything in, we get $1 - `r ssesst` \times `r dfE`/`r dfT`$, which gives us `r adjrsq`.
